...
namespace FSHLib {
    public class FSHImage_OLD {
        ...
        public FSHImage_OLD(Stream stream) {
            this.saveGlobPal = false;
            this.rawData = (byte[]) null;
            this.isFSHComp = false;
            this.isDirty = false;
        ...
        public unsafe void Load(Stream s) {
            ...
            for (int index1 = 0; index1 < numBmps; ++index1) {
                ...
                if ((index1 != numBmps - 1 || num3 == this.fshHead.size) && index1 < numBmps - 1) {
                ...
                int num4 = fshEntryHeader2.code & (int) sbyte.MaxValue;
                int num5;
                switch (num4) {
                    case 97:
                    case 109:
                        ...
                        for (; num14 >= 0; --num14) {
                            ...
                            switch (num4) {
                                case 96:
                                    ...
                                    for (int index4 = (int) fshEntryHeader2.height - 1; index4 >= 0; --index4) {
                                        for (int index5 = 0; index5 < (int) fshEntryHeader2.width; ++index5)
                                            numArray2[index4, index5] = -1;
                                    }
                                    int index6 = (int) fshEntryHeader2.height - 1;
                                    int index7 = 0;
                                    byte[] target1 = new byte[12 * ((int) fshEntryHeader2.width / 4)];
                                    for (int index8 = (int) fshEntryHeader2.height / 4 - 1; index8 >= 0; --index8) {
                                        int num17 = num15 + 2 * index8 * (int) fshEntryHeader2.width;
                                        for (int index9 = 7; index9 >= 4; --index9) {
                                            for (int index10 = 0; index10 < (int) fshEntryHeader2.width / 4; ++index10) {
                                                int c1 = this.GetInt(this.rawData, num17 + 8 * index10);
                                                this.UnpackDXT((byte) ((uint) this.rawData[num17 + 8 * index10 + index9] & 3U), (ushort) c1, (ushort) (c1 >> 16), target1, 12 * index10);
                                                this.UnpackDXT((byte) ((int) this.rawData[num17 + 8 * index10 + index9] >> 2 & 3), (ushort) c1, (ushort) (c1 >> 16), target1, 12 * index10 + 3);
                                                this.UnpackDXT((byte) ((int) this.rawData[num17 + 8 * index10 + index9] >> 4 & 3), (ushort) c1, (ushort) (c1 >> 16), target1, 12 * index10 + 6);
                                                this.UnpackDXT((byte) ((int) this.rawData[num17 + 8 * index10 + index9] >> 6 & 3), (ushort) c1, (ushort) (c1 >> 16), target1, 12 * index10 + 9);
                                                if (index7 >= (int) fshEntryHeader2.width) {
                                                    index7 = 0;
                                                    --index6;
                                                }
                                                int num18 = 0;
                                                numArray1[index6, index7] = (int) target1[12 * index10 + num18] + ((int) target1[12 * index10 + 1 + num18] << 8) + ((int) target1[12 * index10 + 2 + num18] << 16) - 16777216;
                                                int index11 = index7 + 1;
                                                int num19 = num18 + 3;
                                                numArray1[index6, index11] = (int) target1[12 * index10 + num19] + ((int) target1[12 * index10 + 1 + num19] << 8) + ((int) target1[12 * index10 + 2 + num19] << 16) - 16777216;
                                                int index12 = index11 + 1;
                                                int num20 = num19 + 3;
                                                numArray1[index6, index12] = (int) target1[12 * index10 + num20] + ((int) target1[12 * index10 + 1 + num20] << 8) + ((int) target1[12 * index10 + 2 + num20] << 16) - 16777216;
                                                int index13 = index12 + 1;
                                                int num21 = num20 + 3;
                                                numArray1[index6, index13] = (int) target1[12 * index10 + num21] + ((int) target1[12 * index10 + 1 + num21] << 8) + ((int) target1[12 * index10 + 2 + num21] << 16) - 16777216;
                                                index7 = index13 + 1;
                                            }
                                        }
                                    }
